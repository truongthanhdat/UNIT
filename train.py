...
import numpy as np
import UNIT
from utils import Timer, load_images, collect_summaries, get_variables
import yaml
from easydict import EasyDict

def load_params(config_path = "configs/default.yaml"):
    return EasyDict(yaml.load(open(config_path, "r")))

if __name__ == "__main__":
    params = load_params("configs/default.yaml")
    ...
    adv_loss = restore.adv_loss * params.loss.gan
